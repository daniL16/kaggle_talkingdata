...
features = ['ip','app','device','os','channel','is_attributed','click_time_timestamp','hour','day','ip_app_media','ip_app_os_media','ip_app_count','ip_day_hour_count']
int_features = ['ip','app','device','os','channel','click_time_timestamp','hour','day','ip_app_media','ip_app_os_media','ip_app_count','ip_day_hour_count']
